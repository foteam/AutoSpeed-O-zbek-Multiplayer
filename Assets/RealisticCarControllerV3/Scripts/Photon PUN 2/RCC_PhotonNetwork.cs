...
public class RCC_PhotonNetwork : Photon.Pun.MonoBehaviourPunCallbacks, IPunObservable {
    ...
    // Upgrades
    private float frontSuspensions = 0f;
    private float rearSuspensions = 0f;
    ...
    private void GetValues() {
        ...
        frontSuspensions = carController.FrontLeftWheelCollider.WheelCollider.suspensionDistance;
        rearSuspensions = carController.RearLeftWheelCollider.WheelCollider.suspensionDistance;
    ...
    private void FixedUpdate() {
        ...
        if (!isMine) {
            ...
            carController.FrontLeftWheelCollider.WheelCollider.suspensionDistance = frontSuspensions;
            carController.FrontRightWheelCollider.WheelCollider.suspensionDistance = frontSuspensions;
            carController.RearLeftWheelCollider.WheelCollider.suspensionDistance = rearSuspensions;
            carController.RearRightWheelCollider.WheelCollider.suspensionDistance = rearSuspensions;
    ...
    public void OnPhotonSerializeView(PhotonStream stream, PhotonMessageInfo info) {
        ...
        if (stream.IsWriting) {
            ...
            frontSuspensions = (float)stream.ReceiveNext();
            rearSuspensions = (float)stream.ReceiveNext();
